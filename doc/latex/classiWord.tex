...
Defines a \char`\"{}word\char`\"{} of data on the Wi-\/11 Machine. The methods present in this interface are meant to mimic the functionality of the Wi-\/11 machine, allowing for simplified execution of the instructions therein. As the size of a \char`\"{}word\char`\"{} depends on the architecture, classes implementing this interface should define the word length to be 16 bits in length. 
...
When this function returns \char`\"{}False\char`\"{}, the value of the word is unchanged.\par
 Otherwise, the word now holds the value \char`\"{}value\char`\"{}. \hypertarget{classiWord_a6e40a4873ca945b119318a85c75a0fcf}{
...
\end{DoxyReturn}
When this function returns \char`\"{}False\char`\"{}, the value of the word is unchanged.\par
 Otherwise, the word now holds the value \char`\"{}str\char`\"{}. \hypertarget{classiWord_abd4229c26d0a2ff17b0a6bdb74240388}{
...
\end{DoxyReturn}
When this function returns \char`\"{}False\char`\"{}, the value of the word is unchanged.\par
 Otherwise, the word now holds the value \char`\"{}str\char`\"{}. \hypertarget{classiWord_ac5967eac5182607ac41b9ce6c3a74cb8}{
...
\end{DoxyPostcond}
Equivalent to the assignment \char`\"{}caller = parameter\char`\"{}. \hypertarget{classiWord_aaee78600a625153a8282bcec181d0a24}{
\index{iWord@{iWord}!operator=@{operator=}}
\index{operator=@{operator=}!iWord@{iWord}}
\subsubsection[{operator=}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf Word}\& iWord::operator= (
\begin{DoxyParamCaption}
...
\label{classiWord_aaee78600a625153a8282bcec181d0a24}
...
\end{DoxyReturn}
The return value and parameter here must be declared as \char`\"{}Word\char`\"{}s as C++ does not work well with polymorphic assignment operators. \hypertarget{classiWord_af20040c25b79d2aeae41f1714fbb2cbc}{
\index{iWord@{iWord}!operator++@{operator++}}
\index{operator++@{operator++}!iWord@{iWord}}
...
\end{DoxyReturn}
The object increments its value BEFORE the execution of the current line. \hypertarget{classiWord_a6777f6f41915179c4255d3647a9eb4b5}{
\index{iWord@{iWord}!operator++@{operator++}}
\index{operator++@{operator++}!iWord@{iWord}}
\subsubsection[{operator++}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf iWord}\& iWord::operator++ (
\begin{DoxyParamCaption}
...
A reference to itself.
\end{DoxyReturn}
The object increments its value AFTER the execution of the current line. \hypertarget{classiWord_a0e83901b08763247527ce61c89fd847f}{
...
\end{DoxyParagraph}
\hypertarget{classiWord_a6442bd382be2d072d6243cfcb9dd2312}{
...
\label{classiWord_a6442bd382be2d072d6243cfcb9dd2312}
