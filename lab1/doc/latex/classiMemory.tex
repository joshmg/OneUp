...
\index{iMemory@{iMemory}!GetUsedMemory@{GetUsedMemory}}
\index{GetUsedMemory@{GetUsedMemory}!iMemory@{iMemory}}
\subsubsection[{GetUsedMemory}]{\setlength{\rightskip}{0pt plus 5cm}virtual std::vector$<$ std::vector$<${\bf Word}$>$ $>$ iMemory::GetUsedMemory (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}}
